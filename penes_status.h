...
enum PeNESStatus {
    ...
    /* Error statuses for the module memory_manager. */
    PENES_STATUS_MEMORY_MANAGER_GET_MEMORY_STORAGE_NOT_FOUND,
    PENES_STATUS_MEMORY_MANAGER_GET_MEMORY_STORAGE_OUT_OF_BOUNDS,
